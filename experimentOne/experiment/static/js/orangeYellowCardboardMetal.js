/************************************
 * Orange-Yellow || Cardboard-Metal *
 ************************************/
 
 // Initalize psiturk object
var psiTurk = new PsiTurk(uniqueId, adServerLoc, mode);

var OrangeYellow_CardboardMetal = function () {
  ...
  var metal_wood_02 = new Howl({
    src: ["/static/stimuli/audio/materialContinuums/mp3Files/cardboard_metal_02-40.mp3"],
    preload: true,
  });
  ...
  var orangeYellow = [
    //  ["stim", "#f8874f", "orange_yellow_0"],
    ["stim", "#f8884f", "orange_yellow_1"],
    //  ["stim", "#f8894f", "orange_yellow_2"],
    ["stim", "#f88a4f", "orange_yellow_3"],
    //  ["stim", "#f88b4f", "orange_yellow_4"],
    ["stim", "#f88c4f", "orange_yellow_5"],
    //  ["stim", "#f88d4f", "orange_yellow_6"],
    ["stim", "#f88d4f", "orange_yellow_7"],
    //  ["stim", "#f88e4f", "orange_yellow_8"],
    ["stim", "#f98f4f", "orange_yellow_9"],
    //  ["stim", "#f9904f", "orange_yellow_10"],
    ["stim", "#f9914f", "orange_yellow_11"],
    //  ["stim", "#f9924f", "orange_yellow_12"],
    ["stim", "#f9934f", "orange_yellow_13"],
    //  ["stim", "#f9944f", "orange_yellow_14"],
    ["stim", "#f9954f", "orange_yellow_15"],
    //  ["stim", "#f9964f", "orange_yellow_16"],
    ["stim", "#f9964f", "orange_yellow_17"],
    //  ["stim", "#f9974f", "orange_yellow_18"],
    ["stim", "#f9984f", "orange_yellow_19"],
    //  ["stim", "#f9994f", "orange_yellow_20"],
    ["stim", "#f99a4f", "orange_yellow_21"],
    //  ["stim", "#f99b4f", "orange_yellow_22"],
    ["stim", "#f99c50", "orange_yellow_23"],
    //  ["stim", "#f99d50", "orange_yellow_24"],
    ["stim", "#f99e50", "orange_yellow_25"],
    //  ["stim", "#f99e50", "orange_yellow_26"],
    ["stim", "#f99f50", "orange_yellow_27"],
    //  ["stim", "#f9a050", "orange_yellow_28"],
    ["stim", "#f9a150", "orange_yellow_29"],
    //  ["stim", "#f9a250", "orange_yellow_30"],
    ["stim", "#f9a350", "orange_yellow_31"],
    //  ["stim", "#f9a450", "orange_yellow_32"],
    ["stim", "#faa550", "orange_yellow_33"],
    //  ["stim", "#faa550", "orange_yellow_34"],
    ["stim", "#faa650", "orange_yellow_35"],
    //  ["stim", "#faa750", "orange_yellow_36"],
    ["stim", "#faa850", "orange_yellow_37"],
    //  ["stim", "#faa950", "orange_yellow_38"],
    ["stim", "#faaa50", "orange_yellow_39"],
    //  ["stim", "#faab50", "orange_yellow_40"],
    ["stim", "#faac50", "orange_yellow_41"],
    //  ["stim", "#faac50", "orange_yellow_42"],
    ["stim", "#faad50", "orange_yellow_43"],
    //  ["stim", "#faae50", "orange_yellow_44"],
    ["stim", "#faaf50", "orange_yellow_45"],
    //  ["stim", "#fab050", "orange_yellow_46"],
    ["stim", "#fab150", "orange_yellow_47"],
    //  ["stim", "#fab250", "orange_yellow_48"],
    ["stim", "#fab250", "orange_yellow_49"],
    //  ["stim", "#fab350", "orange_yellow_50"],
    ["stim", "#fab450", "orange_yellow_51"],
    //  ["stim", "#fab550", "orange_yellow_52"],
    ["stim", "#fab650", "orange_yellow_53"],
    //  ["stim", "#fab750", "orange_yellow_54"],
    ["stim", "#fab750", "orange_yellow_55"],
    //  ["stim", "#fab850", "orange_yellow_56"],
    ["stim", "#fab950", "orange_yellow_57"],
    //  ["stim", "#faba50", "orange_yellow_58"],
    ["stim", "#fabb50", "orange_yellow_59"],
    //  ["stim", "#fabc50", "orange_yellow_60"],
    ["stim", "#fabd50", "orange_yellow_61"],
    //  ["stim", "#fabd50", "orange_yellow_62"],
    ["stim", "#fabe50", "orange_yellow_63"],
    //  ["stim", "#fabf50", "orange_yellow_64"],
    ["stim", "#fac050", "orange_yellow_65"],
    //  ["stim", "#fac150", "orange_yellow_66"],
    ["stim", "#fac250", "orange_yellow_67"],
    //  ["stim", "#fac250", "orange_yellow_68"],
    ["stim", "#f9c350", "orange_yellow_69"],
    //  ["stim", "#f9c450", "orange_yellow_70"],
    ["stim", "#f9c550", "orange_yellow_71"],
    //  ["stim", "#f9c650", "orange_yellow_72"],
    ["stim", "#f9c750", "orange_yellow_73"],
    //  ["stim", "#f9c750", "orange_yellow_74"],
    ["stim", "#f9c850", "orange_yellow_75"],
    //  ["stim", "#f9c950", "orange_yellow_76"],
    ["stim", "#f9ca50", "orange_yellow_77"],
    //  ["stim", "#f9cb50", "orange_yellow_78"],
    ["stim", "#f9cc50", "orange_yellow_79"],
    //  ["stim", "#f9cc4f", "orange_yellow_80"],
    ["stim", "#f9cd4f", "orange_yellow_81"],
    //  ["stim", "#f9ce4f", "orange_yellow_82"],
    ["stim", "#f9cf4f", "orange_yellow_83"],
    //  ["stim", "#f9d04f", "orange_yellow_84"],
    ["stim", "#f9d04f", "orange_yellow_85"],
    //  ["stim", "#f9d14f", "orange_yellow_86"],
    ["stim", "#f9d24f", "orange_yellow_87"],
    //  ["stim", "#f9d34f", "orange_yellow_88"],
    ["stim", "#f9d44f", "orange_yellow_89"],
    //  ["stim", "#f9d54f", "orange_yellow_90"],
    ["stim", "#f9d54f", "orange_yellow_91"],
    //  ["stim", "#f8d64f", "orange_yellow_92"],
    ["stim", "#f8d74f", "orange_yellow_93"],
    //  ["stim", "#f8d84f", "orange_yellow_94"],
    ["stim", "#f8d94f", "orange_yellow_95"],
    //  ["stim", "#f8da4f", "orange_yellow_96"],
    ["stim", "#f8da4f", "orange_yellow_97"],
    //  ["stim", "#f8db4f", "orange_yellow_98"],
    ["stim", "#f8dc4f", "orange_yellow_99"],
  ];
   ...
   **************/
    ...
    var colorCategoryEnvironment = function () {
      ...
      var responseCountO = 0;
      var responseCountY = 0;
      ...
      var response_handler = function (e) {
        ...
        switch (response) {
          case "orange":
            showColor("#f8874f"); //centre orange
            responseCountO++;
            break;
  
          case "yellow":
            showColor("#f8dc4f"); // centre yellow
            responseCountY++; 
            break;
        ...
        if (responseCountY > 1 && responseCountO > 1) { 
          finish();
        } 
      };
      ...
      // Load the html snippet into the body.
      psiTurk.showPage("stage_OY_category-environment.html");
    ...
    var colorStaircase = function () {
      ...
      var dims = ["orange", "yellow"];
      var dimIndex = [0, 1];
      var colorArrays = [orangeYellow, yellowOrange];
      var currentSteps = [0, 0];
      var stairHistories = [[], []];
      var lastStepDirections = ["", ""];
      var reversalCounts = [0, 0];
      ...
      var response_handler = function (e) {
        ...
        // e.g. last response was 'red' going up, new response is 'orange' going back down - and the reverse case
        var checkReversal = function () {
          if (lastStepDirections[i] === "up" && response != currentDim) {
            reversalCounts[i]++;
          } else if (
        ...
        switch (response) {
          case "orange":
            if (reversalCounts[i] === 0 && currentDim === response && currentStep < 2) {
              orange_high.push(colorArray[currentStep][1]);
            } else if (reversalCounts[i] >= 5 && currentDim === response) {
              orange_low.push(colorArray[currentStep][1]);
              completedDimensions[i] = true;
            } else {
            }
            break;
          ...
          case "yellow":
            if (reversalCounts[i] === 0 && currentDim === response && currentStep < 2) {
              yellow_high.push(colorArray[currentStep][1]);
            } else if (reversalCounts[i] >= 5 && currentDim === response) {
              yellow_low.push(colorArray[currentStep][1]);
              completedDimensions[i] = true;
            } else {
            }
            break;
      ...
      var showNextColor = function (color) {
        ...
        d3.select("#query").html(
          '<p id="prompt">Type "O" for orange, "Y" for yellow</p>'
        );
      };
    ...
    **************/
    var RalphPage = function () { 
      ...
      // Load the html snippet into the body.
      psiTurk.showPage("stage_ralphOY.html");
     ...
     ***********************/
      ...
      //These conditions are counterbalanced by hand. So notice the 7 targets go orange-yellow-orange-yellow-orange-yellow-orange and metal-wood-metal-wood-metal-wood. 
      ...
      var comprehensionPhase = function () {
        ...
        psiTurk.showPage("stage_comprehensionOY.html");
        ...
        //Filler. Sound sufficient. Description: "the yellow wood bat". Correct answer: No: Ralph: Shrug. Took me a second to find it. 
          var trialThree = [
            yellow_high[0], 
            metal_high[0], 
            yellow_high[0], 
            metal_high[0],
            yellow_high[0], // target
            wood_high[0], // target
            "shrug",
            ];
  
        //Critical. Base. Color Sufficient. Description: "the yellow and wooden bat" Correct Answer: Yes. Ralph: Nice description. I found it quickly.
        var trialFour = [
            orange_high[0], 
            metal_high[0], 
            orange_high[0], 
        ...
        //Filler. Sound Sufficient. Description: "the orange bat". Correct Answer: Yes. Ralph: Nice description. I found it quickly. 
        var trialFive = [
          yellow_high[0], 
          metal_high[0], 
          yellow_high[0], 
    ...
    var DescriptionTask = function () {
      ...
      var make_fillers = function (n) {
        ...
        if (metal_high.length > 0 && metal_low.length > 0) {
          ...
          var colors = [orange_high, yellow_high]; // take four high different colours (colour sufficient)
        ...
        if (yellow_low.length > 0 && yellow_high.length > 0) {
          var sounds = [wood_high, metal_high];
          var colors = [orange_high];
        ...
        if (orange_low.length > 0 && orange_high.length > 0) {
          var sounds = [wood_high, metal_high];
          var colors = [yellow_high];
      ...
      var feedback = function(response){
          if(trial[9]=='critical'){ // If it's critical
              if(trial[6]=='color'){  // If Color sufficient
                  if( orange_low.includes(trialPairs[2][0]) || orange_high.includes(trialPairs[2][0]) ){  // and target is orange
                      if(response.includes('orange' || 'Orange' || 'ORANGE')){  // and they say orange, thumbs up
                          thumbs_up();
                      } else { // thumbs down
                          thumbs_down();
                      }
                  } else { // if target yellow
                      if(response.includes('yellow' || 'YELLOW' || 'Yellow')){ // and they respond yellow
                          thumbs_up();
                      } else {
                          thumbs_down();
                      }
              ...
              over = response.includes('wood' || 'Wood' || 'WOOD') + response.includes('metal' || 'Metal' || 'METAL') + response.includes('orange' || 'Orange' || 'ORANGE') + response.includes('yellow' || 'YELLOW' || 'Yellow');
              if(over > 1){
                  shrug();
              } else {
                  if(trial[6]=='color'){  // If Color sufficient
