/*******************************
 * Orange-Yellow || Wood-Glass *
 *******************************/

// Initalize psiturk object
var psiTurk = new PsiTurk(uniqueId, adServerLoc, mode);

var OrangeYellow_WoodGlass = function () {
  // Note that 'Glass' on the continuum will be labelled as metal. This makes it simpler - as bats truly vary in these materials.

  //record the condition - this way we can initialise variables as wood/metal, while knowing the true continuum.
  ...
  var metal_wood_00 = new Howl({
    src: ["/static/stimuli/audio/materialContinuums/mp3Files/wood_glass_00-40.mp3"],
    preload: true,
  });

  var metal_wood_01 = new Howl({
    src: ["/static/stimuli/audio/materialContinuums/mp3Files/wood_glass_05-40.mp3"],
    preload: true,
  });
